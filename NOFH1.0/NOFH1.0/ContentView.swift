...
struct WalkthroughScreen: View {
    ...
    var body: some View{
        ...
        ZStack{
            ...
            if currentPage == 1{
                ScreenView(image: "Video call-pana", title: "Meet people in a quick way", subtitle:"NOFH allows people from all over the world to meet quickly and get to know each other." , detail: "", bgColor: Color("Color1"))
                    .transition(.scale)
